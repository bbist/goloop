...
import static foundation.icon.ee.util.bn256.Params.R;
import static foundation.icon.ee.util.bn256.Params.TWIST_MUL_BY_P_X;
import static foundation.icon.ee.util.bn256.Params.TWIST_MUL_BY_P_Y;
